 ...
 * Incluye animación y pulso para llamar la atención
 */
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      {/* Botón principal */}
      <div className="relative bg-green-500 hover:bg-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 group-hover:scale-110">
        <svg
          className="w-8 h-8"
          fill="currentColor"
          viewBox="0 0 24 24"
